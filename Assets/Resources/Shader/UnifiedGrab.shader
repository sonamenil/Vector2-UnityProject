...
uniform float4 _BMMeshSharedGT_TexelSize;
...
OUT_Data_Frag frag(v2f in_f)
{
    ...
    bump_7 = tmpvar_8;
    tmpvar_2.xy = (((bump_7 * _BumpAmt) * (_BMMeshSharedGT_TexelSize.xy * in_f.xlv_TEXCOORD0.z)) + in_f.xlv_TEXCOORD0.xy);
    float4 tmpvar_9;
    tmpvar_9 = tex2D(_BMMeshSharedGT, tmpvar_2);
    col_6 = tmpvar_9;
    float4 tmpvar_10;
