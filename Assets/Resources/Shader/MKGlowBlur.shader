...
OUT_Data_Vert vert(appdata_t in_v)
{
    ...
    float4 tmpvar_4;
    float tmpvar_5;
    tmpvar_5 = (_MainTex_TexelSize.x * _BlurOffsets.x);
    offX_2 = tmpvar_5;
    float tmpvar_6;
    tmpvar_6 = (_MainTex_TexelSize.y * _BlurOffsets.y);
    offY_1 = tmpvar_6;
    float2 tmpvar_7;
    tmpvar_7.x = offX_2;
    tmpvar_7.y = offY_1;
    float2 tmpvar_8;
    tmpvar_8 = (in_v.texcoord.xy - tmpvar_7);
    float2 tmpvar_9;
    tmpvar_9.x = offX_2;
    tmpvar_9.y = offY_1;
    tmpvar_3.xy = float2((tmpvar_8 + tmpvar_9));
    float2 tmpvar_10;
    tmpvar_10.x = (-offX_2);
    tmpvar_10.y = offY_1;
    tmpvar_3.zw = (tmpvar_8 + tmpvar_10);
    float2 tmpvar_11;
    tmpvar_11.x = offX_2;
    tmpvar_11.y = (-offY_1);
    tmpvar_4.xy = float2((tmpvar_8 + tmpvar_11));
    float2 tmpvar_12;
    tmpvar_12.x = (-offX_2);
    tmpvar_12.y = (-offY_1);
    tmpvar_4.zw = (tmpvar_8 + tmpvar_12);
