...
OUT_Data_Frag frag(v2f in_f)
{
    ...
    float tmpvar_3;
    float tmpvar_4;
    tmpvar_4 = clamp((((1 - (2 * abs((in_f.xlv_TEXCOORD0.y - 0.5)))) - 0.05) / 0.94), 0, 1);
    tmpvar_3 = (tmpvar_4 * (tmpvar_4 * (3 - (2 * tmpvar_4))));
    Distance_2 = tmpvar_3;
    xlat_mutable_Color.w = Distance_2;
