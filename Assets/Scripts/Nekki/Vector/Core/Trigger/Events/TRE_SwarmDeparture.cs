...
{
	public class TRE_SwarmDeparture : TriggerRunnerEvent
	{
		private static List<TriggerRunner> _WithThisEvent;

		public string WayPointKey;

		public TRE_SwarmDeparture(TriggerRunner p_parent, string p_wayPointKey)
		{
			_Type = EventType.TRE_SWARM_DEPARTURE;
		...
		public static void ActivateThisEvent(string p_wayPointKey)
		{
			...
			TRE_SwarmDeparture p_event = new TRE_SwarmDeparture(null, p_wayPointKey);
