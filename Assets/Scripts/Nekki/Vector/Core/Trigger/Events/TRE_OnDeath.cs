...
{
	public class TRE_OnDeath : TriggerRunnerEvent
	{
		private static List<TriggerRunner> _WithThisEvent;

		public TRE_OnDeath(TriggerRunner p_parent)
		{
			_Type = EventType.TRE_ON_DEATH;
			if (p_parent != null)
			{
		...
		public static void ActivateThisEvent()
		{
			...
			TRE_OnDeath p_event = new TRE_OnDeath(null);
