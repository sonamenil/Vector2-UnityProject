...
{
	public class TPEE_FloorStart : TriggerPassiveEffectEvent
	{
		public const string NodeName = "FloorStart";

		public static List<TriggerPassiveEffectLoop> LoopsWithEvent;

		public TPEE_FloorStart(TriggerPassiveEffectLoop p_parent)
		{
			_Type = EventType.TPEE_FLOOR_START;
			if (p_parent != null)
			{
		...
		{
			TriggerPassiveEffectEvent.CheckEvent(new TPEE_FloorStart(null), LoopsWithEvent, p_delayAction);
		}
