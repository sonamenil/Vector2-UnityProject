...
{
	public class TRE_StartGame : TriggerRunnerEvent
	{
		private static List<TriggerRunner> _WithThisEvent;

		public TRE_StartGame(TriggerRunner p_parent)
		{
			_Type = EventType.TRE_ON_START_GAME;
			if (p_parent != null)
			{
		...
		public static void ActivateThisEvent()
		{
			...
			TRE_StartGame p_event = new TRE_StartGame(null);
