...
{
	public class TPEE_AnimationStart : TriggerPassiveEffectEvent
	{
		public const string NodeName = "AnimationStart";

		public static List<TriggerPassiveEffectLoop> LoopsWithEvent;

		public TPEE_AnimationStart(TriggerPassiveEffectLoop p_parent)
		{
			_Type = EventType.TPEE_ANIMATION_START;
			if (p_parent != null)
			{
		...
		{
			TriggerPassiveEffectEvent.CheckEvent(new TPEE_AnimationStart(null), LoopsWithEvent, p_delayAction);
		}
