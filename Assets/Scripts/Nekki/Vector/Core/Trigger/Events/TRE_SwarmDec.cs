...
{
	public class TRE_SwarmDec : TriggerRunnerEvent
	{
		private static List<TriggerRunner> _WithThisEvent;

		public string WayPointKey;

		public TRE_SwarmDec(TriggerRunner p_parent, string p_wayPointKey)
		{
			_Type = EventType.TRE_SWARM_DEC;
		...
		public static void ActivateThisEvent(string p_wayPointKey)
		{
			...
			TRE_SwarmDec p_event = new TRE_SwarmDec(null, p_wayPointKey);
