...
{
	public class TPEA_SetCharge : TriggerPassiveEffectAction
	{
		public const string NodeName = "SetCharge";
		...
		private TPEA_SetCharge(TPEA_SetCharge p_copyAction)
			: base(p_copyAction)
		{
		...
		public TPEA_SetCharge(XmlNode p_node, TriggerPassiveEffectLoop p_parent)
			: base(p_parent)
		{
		...
		{
			return new TPEA_SetCharge(this);
		}

		public override string ToString()
		{
			return string.Format("SetCharge GadgetName={0}, Count={1}, ChargeType={2}", _GadgetName.DebugStringValue, _Count.DebugStringValue, _ChargeType.DebugStringValue);
		}
	}
}
