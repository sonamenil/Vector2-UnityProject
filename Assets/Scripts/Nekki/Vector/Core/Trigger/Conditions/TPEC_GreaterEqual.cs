...
{
	public class TPEC_GreaterEqual : TPEC_Compare
	{
		public const string NodeName = "GreaterEqual";

		public TPEC_GreaterEqual(TriggerPassiveEffectLoop p_parent, XmlNode p_node)
