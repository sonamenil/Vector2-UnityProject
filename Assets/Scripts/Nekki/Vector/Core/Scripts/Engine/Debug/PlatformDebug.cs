...
{
    public class PlatformDebug : Quad
    {
        ...
        protected PlatformRunner _Platform;
        ...
        public override QuadRunner Base
        {
            ...
            {
                base.Base = value;
                _Platform = value as PlatformRunner;
                _Color = Settings.Visual.Platform.Border;
                _BackgoundColor = Settings.Visual.Platform.Background;
            }
        }
        ...
        private void SetElipsShader()
        {
            ...
            _Material.SetFloat("_Border", 250f / Mathf.Max(_Platform.Rectangle.Size.Height, _Platform.Rectangle.Size.Width));
