...
{
	public class VF_GetCardInfo : VariableFunction
	{
		...
		protected internal VF_GetCardInfo(string p_value, string p_name, IVariableParent p_parent)
		...
		{
			return Variable.CreateVariable(CardsManager.Current.GetCardInfo(_Params), string.Empty);
		}
