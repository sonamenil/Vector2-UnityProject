...
{
	public class JObject : JContainer, IEnumerable, ICustomTypeDescriptor, IDictionary<string, JToken>, ICollection<KeyValuePair<string, JToken>>, INotifyPropertyChanged, IEnumerable<KeyValuePair<string, JToken>>
	{
