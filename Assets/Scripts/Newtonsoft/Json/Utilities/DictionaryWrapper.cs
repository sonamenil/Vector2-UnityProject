...
{
	internal class DictionaryWrapper<TKey, TValue> : IEnumerable, IDictionary, ICollection, IWrappedDictionary, IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>
	{
