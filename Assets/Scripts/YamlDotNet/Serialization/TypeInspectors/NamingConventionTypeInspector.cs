...
namespace YamlDotNet.Serialization.TypeInspectors
{
	public sealed class NamingConventionTypeInspector : TypeInspectorSkeleton
	{
		...
		{
			return innerTypeDescriptor.GetProperties(type, container).Select((Func<IPropertyDescriptor, IPropertyDescriptor>)((IPropertyDescriptor p) => new PropertyDescriptor(p)
			{
