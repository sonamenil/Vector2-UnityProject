...
namespace BestHTTP.SignalR.Transports
{
	public sealed class PollingTransport : PostSendTransportBase, IHeartbeat
	{
		...
		public override void Connect()
		{
			...
			HTTPRequest hTTPRequest = new HTTPRequest(base.Connection.BuildUri(type, this), HTTPMethods.Get, true, true, OnConnectRequestFinished);
		...
		private void Poll()
		{
			pollRequest = new HTTPRequest(base.Connection.BuildUri(RequestTypes.Poll, this), HTTPMethods.Get, true, true, OnPollRequestFinished);
